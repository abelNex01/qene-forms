...
import { PenTool, Terminal, PlayCircle } from "lucide-react";
          ...
          <div className="max-w-2xl relative">
            ...
            >
                ...
                <Button 
                    ...
                    onClick={() => {
                      setActiveData({
                        ...
                        content: (
                          <div className="w-full aspect-video bg-black/50 border border-white/10 rounded overflow-hidden relative group">
                             <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-transparent transition-all z-10 pointer-events-none">
                                <span className="px-2 py-1 bg-black/50 border border-white/10 rounded text-[10px] font-mono text-white/70">PREVIEW_MODE</span>
                             </div>
                             <img 
                               src="/assets/dashboard-demo.webp" 
                               alt="Dashboard Demo"
                ...
                >
                    ...
                    <span>
                      <DecryptedText text="WATCH TUTORIAL" animateOn="hover" speed={40} maxIterations={10} />
                    </span>
                </Button>
            </motion.div>
          </div>
