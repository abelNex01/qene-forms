...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-[85vh] flex flex-col justify-center relative overflow-hidden grid-pattern pt-20 md:pt-14"
    >
      ...
      <Dialog open={isPlaying} onOpenChange={setIsPlaying}>
        <DialogContent className="max-w-[90vw] w-full p-0 overflow-hidden bg-black border-none h-auto">
